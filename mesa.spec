...
#
Name     : mesa
Version  : 19.3+2445.g8a32f57fff5
Release  : 240
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8a32f57fff56b3b94f1b5589feba38016f39427c/mesa-19.3+2445-g8a32f57fff5.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8a32f57fff56b3b94f1b5589feba38016f39427c/mesa-19.3+2445-g8a32f57fff5.tar.bz2
...
%prep
%setup -q -n mesa-8a32f57fff56b3b94f1b5589feba38016f39427c
cd %{_builddir}/mesa-8a32f57fff56b3b94f1b5589feba38016f39427c
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-8a32f57fff56b3b94f1b5589feba38016f39427c build32
popd
pushd ..
cp -a mesa-8a32f57fff56b3b94f1b5589feba38016f39427c buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579882508
unset LD_AS_NEEDED
...
-Dgallium-opencl=disabled builddir32
ninja -v -C builddir32

%install
mkdir -p %{buildroot}/usr/share/package-licenses/mesa
cp %{_builddir}/mesa-8a32f57fff56b3b94f1b5589feba38016f39427c/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-8a32f57fff56b3b94f1b5589feba38016f39427c/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
