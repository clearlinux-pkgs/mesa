...
#
Name     : mesa
Version  : 23.1+2884.gda4b27452b3
Release  : 488
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/da4b27452b3cd169298012cc88d5ed19bbaa30b9/mesa-23.1+2884-gda4b27452b3.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/da4b27452b3cd169298012cc88d5ed19bbaa30b9/mesa-23.1+2884-gda4b27452b3.tar.bz2
...
%prep
%setup -q -n mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9
cd %{_builddir}/mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9 build32
popd
pushd ..
cp -a mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686574604
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-da4b27452b3cd169298012cc88d5ed19bbaa30b9/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
