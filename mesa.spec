...
%prep
%setup -q -n mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c
cd %{_builddir}/mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c build32
popd
pushd ..
cp -a mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c buildavx2
popd
...
cp %{_builddir}/mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-8023ede00adf08359e6d0c2ebd6e62ebbbcc3c4c/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
