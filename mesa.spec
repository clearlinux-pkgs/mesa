...
#
Name     : mesa
Version  : 22.3+2366.g4429bdd7f5a
Release  : 397
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/mesa-22.3+2366-g4429bdd7f5a.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/mesa-22.3+2366-g4429bdd7f5a.tar.bz2
...
%prep
%setup -q -n mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e
cd %{_builddir}/mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e
%patch1 -p1
pushd ..
cp -a mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e build32
popd
pushd ..
cp -a mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672456932
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-4429bdd7f5a2e4610d3a8677cfbd3e7e2712751e/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
