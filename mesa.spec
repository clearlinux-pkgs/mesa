...
Version  : 22.1.7
Release  : 322
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-22.1.7/mesa-mesa-22.1.7.tar.gz
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-22.1.7/mesa-mesa-22.1.7.tar.gz
...
%prep
%setup -q -n mesa-mesa-22.1.7
cd %{_builddir}/mesa-mesa-22.1.7
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-mesa-22.1.7 build32
popd
pushd ..
cp -a mesa-mesa-22.1.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661187738
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-mesa-%{version}/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/ef04a499b857c3f38d05d737419bb4ec98bfa4fa
