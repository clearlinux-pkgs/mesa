...
Version  : 20.3.3
Release  : 257
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-20.3.3/mesa-mesa-20.3.3.tar.gz
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-20.3.3/mesa-mesa-20.3.3.tar.gz
...
%prep
%setup -q -n mesa-mesa-20.3.3
cd %{_builddir}/mesa-mesa-20.3.3
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-mesa-20.3.3 build32
popd
pushd ..
cp -a mesa-mesa-20.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610647443
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-mesa-20.3.3/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/e8896843438d011255b0a3795f7e0dd3126f1c7d
cp %{_builddir}/mesa-mesa-20.3.3/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-mesa-20.3.3/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
