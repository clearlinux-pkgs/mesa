...
%prep
%setup -q -n mesa-23ee6ca801cf9220dd544e6d659d683104f92c74
cd %{_builddir}
...
cd %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74
mkdir -p ./subprojects/paste-1.0.14
cp -r %{_builddir}/paste-1.0.14/* %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/./subprojects/paste-1.0.14
mkdir -p ./subprojects/syn-2.0.39
cp -r %{_builddir}/syn-2.0.39/* %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/./subprojects/syn-2.0.39
mkdir -p ./subprojects/proc-macro2-1.0.70
cp -r %{_builddir}/proc-macro2-1.0.70/* %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/./subprojects/proc-macro2-1.0.70
mkdir -p ./subprojects/quote-1.0.33
cp -r %{_builddir}/quote-1.0.33/* %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/./subprojects/quote-1.0.33
mkdir -p ./subprojects/unicode-ident-1.0.12
cp -r %{_builddir}/unicode-ident-1.0.12/* %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/./subprojects/unicode-ident-1.0.12
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-23ee6ca801cf9220dd544e6d659d683104f92c74 build32
popd
pushd ..
cp -a mesa-23ee6ca801cf9220dd544e6d659d683104f92c74 buildavx2
popd
...
cp %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-23ee6ca801cf9220dd544e6d659d683104f92c74/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
