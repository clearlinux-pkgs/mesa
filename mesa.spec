...
#
Name     : mesa
Version  : 23.0+3395.g5e8866a35a2
Release  : 436
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/5e8866a35a2594588b6c9937125eb9a70b02afeb/mesa-23.0+3395-g5e8866a35a2.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/5e8866a35a2594588b6c9937125eb9a70b02afeb/mesa-23.0+3395-g5e8866a35a2.tar.bz2
...
%prep
%setup -q -n mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb
cd %{_builddir}/mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb
%patch1 -p1
pushd ..
cp -a mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb build32
popd
pushd ..
cp -a mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679501830
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-5e8866a35a2594588b6c9937125eb9a70b02afeb/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
