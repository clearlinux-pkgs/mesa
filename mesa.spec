...
Version  : 22.2.0.rc3
Release  : 324
URL      : https://archive.mesa3d.org/mesa-22.2.0-rc3.tar.xz
Source0  : https://archive.mesa3d.org/mesa-22.2.0-rc3.tar.xz
...
%prep
%setup -q -n mesa-22.2.0-rc3
cd %{_builddir}/mesa-22.2.0-rc3
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mesa-22.2.0-rc3 build32
popd
pushd ..
cp -a mesa-22.2.0-rc3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661376912
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-22.2.0-rc3/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-22.2.0-rc3/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-22.2.0-rc3/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
