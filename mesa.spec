...
#
Name     : mesa
Version  : 23.2.0+2982.g78ec03b3ba6
Release  : 530
...
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/78ec03b3ba65d221c78930e87616eef53f0fcf6c/mesa-23.2.0+2982-g78ec03b3ba6.tar.bz2
...
%prep
%setup -q -n mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c
cd %{_builddir}/mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c build32
popd
pushd ..
cp -a mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693321749
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-78ec03b3ba65d221c78930e87616eef53f0fcf6c/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
