...
#
Name     : mesa
Version  : 22.3+2400.g980df9ede18
Release  : 400
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/980df9ede1887c60d9fc82e7e08b3f63c3745d59/mesa-22.3+2400-g980df9ede18.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/980df9ede1887c60d9fc82e7e08b3f63c3745d59/mesa-22.3+2400-g980df9ede18.tar.bz2
...
%prep
%setup -q -n mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59
cd %{_builddir}/mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59
%patch1 -p1
pushd ..
cp -a mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59 build32
popd
pushd ..
cp -a mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672728045
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-980df9ede1887c60d9fc82e7e08b3f63c3745d59/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
