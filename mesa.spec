...
#
Name     : mesa
Version  : 24.1+343.gbed4ad26ad0
Release  : 729
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/bed4ad26ad050ac6ea38167411277b4f110eb48f/mesa-24.1+343-gbed4ad26ad0.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/bed4ad26ad050ac6ea38167411277b4f110eb48f/mesa-24.1+343-gbed4ad26ad0.tar.bz2
...
%prep
%setup -q -n mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f
cd %{_builddir}/mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f build32
popd
pushd ..
cp -a mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714678572
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-bed4ad26ad050ac6ea38167411277b4f110eb48f/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
