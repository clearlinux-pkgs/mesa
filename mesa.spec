...
%prep
%setup -q -n mesa-mesa-21.0.1
cd %{_builddir}/mesa-mesa-21.0.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-mesa-21.0.1 build32
popd
pushd ..
cp -a mesa-mesa-21.0.1 buildavx2
popd
...
cp %{_builddir}/mesa-mesa-21.0.1/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/e8896843438d011255b0a3795f7e0dd3126f1c7d
cp %{_builddir}/mesa-mesa-21.0.1/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-mesa-21.0.1/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
