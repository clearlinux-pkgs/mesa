...
#
Name     : mesa
Version  : 23.1+2360.g900deea4cf7
Release  : 478
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/mesa-23.1+2360-g900deea4cf7.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/mesa-23.1+2360-g900deea4cf7.tar.bz2
...
%prep
%setup -q -n mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85
cd %{_builddir}/mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85 build32
popd
pushd ..
cp -a mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685671777
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-900deea4cf7e8b9a28a904e8c6e21dd82dba2a85/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
