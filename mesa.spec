...
#
Name     : mesa
Version  : 24.1+388.g7de8a010876
Release  : 730
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/mesa-24.1+388-g7de8a010876.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/mesa-24.1+388-g7de8a010876.tar.bz2
...
%prep
%setup -q -n mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569
cd %{_builddir}/mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569 build32
popd
pushd ..
cp -a mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714768016
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-7de8a010876b6e1fdf7fc8cf15f3f0e10ba5c569/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
