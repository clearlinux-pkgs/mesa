...
#
Name     : mesa
Version  : 19.3+3182.g8291d728dc9
Release  : 243
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8291d728dc997e87b4d2e4e451692643a1dba881/mesa-19.3+3182-g8291d728dc9.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8291d728dc997e87b4d2e4e451692643a1dba881/mesa-19.3+3182-g8291d728dc9.tar.bz2
...
%prep
%setup -q -n mesa-8291d728dc997e87b4d2e4e451692643a1dba881
cd %{_builddir}/mesa-8291d728dc997e87b4d2e4e451692643a1dba881
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-8291d728dc997e87b4d2e4e451692643a1dba881 build32
popd
pushd ..
cp -a mesa-8291d728dc997e87b4d2e4e451692643a1dba881 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582220443
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-8291d728dc997e87b4d2e4e451692643a1dba881/docs/license.html %{buildroot}/usr/share/package-licenses/mesa/8abacb09e25b69edf7b2ef6ac57b6be407769239
cp %{_builddir}/mesa-8291d728dc997e87b4d2e4e451692643a1dba881/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-8291d728dc997e87b4d2e4e451692643a1dba881/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
