...
%prep
%setup -q -n mesa-mesa-22.1.6
cd %{_builddir}/mesa-mesa-22.1.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-mesa-22.1.6 build32
popd
pushd ..
cp -a mesa-mesa-22.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660169892
unset LD_AS_NEEDED
