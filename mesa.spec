...
#
Name     : mesa
Version  : 23.2.0+4534.g16fa4621b8f
Release  : 570
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/16fa4621b8fbb185fd8219be6540183bfe942f0d/mesa-23.2.0+4534-g16fa4621b8f.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/16fa4621b8fbb185fd8219be6540183bfe942f0d/mesa-23.2.0+4534-g16fa4621b8f.tar.bz2
...
%prep
%setup -q -n mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d
cd %{_builddir}/mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d build32
popd
pushd ..
cp -a mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696841496
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-16fa4621b8fbb185fd8219be6540183bfe942f0d/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
