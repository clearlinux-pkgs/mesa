...
#
Name     : mesa
Version  : 23.2.0+61.g5f5be9e4e10
Release  : 508
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/5f5be9e4e10a487e60dc7a04affa5405e51c06bd/mesa-23.2.0+61-g5f5be9e4e10.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/5f5be9e4e10a487e60dc7a04affa5405e51c06bd/mesa-23.2.0+61-g5f5be9e4e10.tar.bz2
...
%prep
%setup -q -n mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd
cd %{_builddir}/mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd build32
popd
pushd ..
cp -a mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689319512
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-5f5be9e4e10a487e60dc7a04affa5405e51c06bd/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
