...
#
Name     : mesa
Version  : 20.1+3492.400c2ff226
Release  : 251
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1/mesa-20.1+3492-ga400c2ff226.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1/mesa-20.1+3492-ga400c2ff226.tar.bz2
...
%prep
%setup -q -n mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1
cd %{_builddir}/mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1 build32
popd
pushd ..
cp -a mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595972043
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/e8896843438d011255b0a3795f7e0dd3126f1c7d
cp %{_builddir}/mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-a400c2ff2265dfabb1ed7b59c8b24aa38d0557d1/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
