...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608165092
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-mesa-20.3.1/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/e8896843438d011255b0a3795f7e0dd3126f1c7d
cp %{_builddir}/mesa-mesa-20.3.1/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-mesa-20.3.1/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
