...
#
Name     : mesa
Version  : 22.2+4346.c961a28f85
Release  : 368
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/cc961a28f85b75ecb97d5c6d46c46afd6af60b65/mesa-22.2+4346-gcc961a28f85.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/cc961a28f85b75ecb97d5c6d46c46afd6af60b65/mesa-22.2+4346-gcc961a28f85.tar.bz2
...
%prep
%setup -q -n mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65
cd %{_builddir}/mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65
%patch1 -p1
pushd ..
cp -a mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65 build32
popd
pushd ..
cp -a mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666836588
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-cc961a28f85b75ecb97d5c6d46c46afd6af60b65/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
