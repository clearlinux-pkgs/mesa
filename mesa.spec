...
#
Name     : mesa
Version  : 22.2+3391.g55f6a2bb51a
Release  : 359
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/mesa-22.2+3391-g55f6a2bb51a.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/mesa-22.2+3391-g55f6a2bb51a.tar.bz2
...
%prep
%setup -q -n mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269
cd %{_builddir}/mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269
%patch1 -p1
pushd ..
cp -a mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269 build32
popd
pushd ..
cp -a mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665416581
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-55f6a2bb51a1fadcd68f9f09ccf4435a4e4ca269/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
