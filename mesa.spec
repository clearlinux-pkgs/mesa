...
#
Name     : mesa
Version  : 22.2+1923.gdcc52618952
Release  : 344
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/dcc52618952d0e0f2745c0ee443b620cea37ac68/mesa-22.2+1923-gdcc52618952.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/dcc52618952d0e0f2745c0ee443b620cea37ac68/mesa-22.2+1923-gdcc52618952.tar.bz2
...
%prep
%setup -q -n mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68
cd %{_builddir}/mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68
%patch1 -p1
pushd ..
cp -a mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68 build32
popd
pushd ..
cp -a mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662851460
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-dcc52618952d0e0f2745c0ee443b620cea37ac68/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
