...
#
Name     : mesa
Version  : 24.1+3155.gde0d237ab0b
Release  : 758
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/mesa-24.1+3155-gde0d237ab0b.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/mesa-24.1+3155-gde0d237ab0b.tar.bz2
Source1  : https://static.crates.io/crates/paste/paste-1.0.14.crate
Source2  : https://static.crates.io/crates/proc-macro2/proc-macro2-1.0.70.crate
Source3  : https://static.crates.io/crates/quote/quote-1.0.33.crate
Source4  : https://static.crates.io/crates/syn/syn-2.0.39.crate
...
%prep
%setup -q -n mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022
cd %{_builddir}
tar xf %{_sourcedir}/paste-1.0.14.crate
cd %{_builddir}
tar xf %{_sourcedir}/syn-2.0.39.crate
cd %{_builddir}
tar xf %{_sourcedir}/proc-macro2-1.0.70.crate
cd %{_builddir}
tar xf %{_sourcedir}/quote-1.0.33.crate
cd %{_builddir}
tar xf %{_sourcedir}/unicode-ident-1.0.12.crate
cd %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022
mkdir -p ./subprojects/paste-1.0.14
cp -r %{_builddir}/paste-1.0.14/* %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/./subprojects/paste-1.0.14
mkdir -p ./subprojects/syn-2.0.39
cp -r %{_builddir}/syn-2.0.39/* %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/./subprojects/syn-2.0.39
mkdir -p ./subprojects/proc-macro2-1.0.70
cp -r %{_builddir}/proc-macro2-1.0.70/* %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/./subprojects/proc-macro2-1.0.70
mkdir -p ./subprojects/quote-1.0.33
cp -r %{_builddir}/quote-1.0.33/* %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/./subprojects/quote-1.0.33
mkdir -p ./subprojects/unicode-ident-1.0.12
cp -r %{_builddir}/unicode-ident-1.0.12/* %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/./subprojects/unicode-ident-1.0.12
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022 build32
popd
pushd ..
cp -a mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719885817
unset LD_AS_NEEDED
...
-Dgallium-xa=enabled \
-Dgallium-opencl=icd \
-Dvulkan-drivers=intel,amd,intel_hasvk,swrast,virtio,swrast,nouveau \
...
cp %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-de0d237ab0ba55ecb2dd3dfd4b28152c2963f022/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
...
cp %{_builddir}/proc-macro2-1.0.70/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/mesa/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/proc-macro2-1.0.70/LICENSE-MIT %{buildroot}/usr/share/package-licenses/mesa/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
cp %{_builddir}/syn-2.0.39/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/mesa/6e5c4711bcae04967d7f5b5e01cf56ae03bebe7a || :
cp %{_builddir}/syn-2.0.39/LICENSE-MIT %{buildroot}/usr/share/package-licenses/mesa/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
