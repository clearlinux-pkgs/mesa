...
#
Name     : mesa
Version  : 19.3+2601.a6a22305b2
Release  : 241
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d/mesa-19.3+2601-gca6a22305b2.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d/mesa-19.3+2601-gca6a22305b2.tar.bz2
...
%prep
%setup -q -n mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d
cd %{_builddir}/mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d build32
popd
pushd ..
cp -a mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580319950
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-ca6a22305b275b49fbc88b8f4cba2fefb24c2a5d/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
