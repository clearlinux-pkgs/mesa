...
#
Name     : mesa
Version  : 22.3+2135.g50b7d36428b
Release  : 388
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/50b7d36428b2175fe407d3559d06e0a890e94d1b/mesa-22.3+2135-g50b7d36428b.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/50b7d36428b2175fe407d3559d06e0a890e94d1b/mesa-22.3+2135-g50b7d36428b.tar.bz2
...
%prep
%setup -q -n mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b
cd %{_builddir}/mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b
%patch1 -p1
pushd ..
cp -a mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b build32
popd
pushd ..
cp -a mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671229133
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-50b7d36428b2175fe407d3559d06e0a890e94d1b/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
