...
#
Name     : mesa
Version  : 22.2+3336.gdf3fdbdeb50
Release  : 358
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/mesa-22.2+3336-gdf3fdbdeb50.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/mesa-22.2+3336-gdf3fdbdeb50.tar.bz2
...
%prep
%setup -q -n mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c
cd %{_builddir}/mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c
%patch1 -p1
pushd ..
cp -a mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c build32
popd
pushd ..
cp -a mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665074011
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-df3fdbdeb50b7b240a7ec81a5ea08e3541d2a51c/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
