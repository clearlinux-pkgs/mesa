...
#
Name     : mesa
Version  : 24.1+2957.gdd85b50d182
Release  : 754
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/mesa-24.1+2957-gdd85b50d182.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/mesa-24.1+2957-gdd85b50d182.tar.bz2
...
%prep
%setup -q -n mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c
cd %{_builddir}
...
cd %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c
mkdir -p ./subprojects/paste-1.0.14
cp -r %{_builddir}/paste-1.0.14/* %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/./subprojects/paste-1.0.14
mkdir -p ./subprojects/syn-2.0.39
cp -r %{_builddir}/syn-2.0.39/* %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/./subprojects/syn-2.0.39
mkdir -p ./subprojects/proc-macro2-1.0.70
cp -r %{_builddir}/proc-macro2-1.0.70/* %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/./subprojects/proc-macro2-1.0.70
mkdir -p ./subprojects/quote-1.0.33
cp -r %{_builddir}/quote-1.0.33/* %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/./subprojects/quote-1.0.33
mkdir -p ./subprojects/unicode-ident-1.0.12
cp -r %{_builddir}/unicode-ident-1.0.12/* %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/./subprojects/unicode-ident-1.0.12
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c build32
popd
pushd ..
cp -a mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719434728
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-dd85b50d182a2bd1c67d9a8f858d93fc4dded91c/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
