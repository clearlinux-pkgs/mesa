...
#
Name     : mesa
Version  : 23.1+290.gd6b30d42b05
Release  : 462
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/mesa-23.1+290-gd6b30d42b05.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/mesa-23.1+290-gd6b30d42b05.tar.bz2
...
%prep
%setup -q -n mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a
cd %{_builddir}/mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a
%patch1 -p1
pushd ..
cp -a mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a build32
popd
pushd ..
cp -a mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681922559
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-d6b30d42b05a93aa80c93c7fcc1782f9c59a6f1a/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
