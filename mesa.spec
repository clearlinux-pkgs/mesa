...
#
Name     : mesa
Version  : 24.1+1176.gb4bd3807045
Release  : 741
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/b4bd3807045a5656848ced72ae5fbfa539b89d26/mesa-24.1+1176-gb4bd3807045.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/b4bd3807045a5656848ced72ae5fbfa539b89d26/mesa-24.1+1176-gb4bd3807045.tar.bz2
...
%prep
%setup -q -n mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26
cd %{_builddir}/mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
pushd ..
cp -a mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26 build32
popd
pushd ..
cp -a mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716032656
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-b4bd3807045a5656848ced72ae5fbfa539b89d26/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
