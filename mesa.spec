...
#
Name     : mesa
Version  : 22.2+1924.93b72d0455
Release  : 345
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/mesa-22.2+1924-gc93b72d0455.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/mesa-22.2+1924-gc93b72d0455.tar.bz2
...
%prep
%setup -q -n mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35
cd %{_builddir}/mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35
%patch1 -p1
pushd ..
cp -a mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35 build32
popd
pushd ..
cp -a mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662919313
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-c93b72d0455f1487fa3fb65a6691ff44a2fbcd35/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
