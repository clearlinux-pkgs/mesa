...
#
Name     : mesa
Version  : 24.3+546.g83c2d82637d
Release  : 826
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/83c2d82637d2b7d37a8d32d3ddcab28160fce04d/mesa-24.3+546-g83c2d82637d.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/83c2d82637d2b7d37a8d32d3ddcab28160fce04d/mesa-24.3+546-g83c2d82637d.tar.bz2
...
%prep
%setup -q -n mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d
cd %{_builddir}
...
cd %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d
mkdir -p ./subprojects/paste-1.0.14
cp -r %{_builddir}/paste-1.0.14/* %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/./subprojects/paste-1.0.14
mkdir -p ./subprojects/syn-2.0.68
cp -r %{_builddir}/syn-2.0.68/* %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/./subprojects/syn-2.0.68
mkdir -p ./subprojects/proc-macro2-1.0.86
cp -r %{_builddir}/proc-macro2-1.0.86/* %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/./subprojects/proc-macro2-1.0.86
mkdir -p ./subprojects/quote-1.0.33
cp -r %{_builddir}/quote-1.0.33/* %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/./subprojects/quote-1.0.33
mkdir -p ./subprojects/unicode-ident-1.0.12
cp -r %{_builddir}/unicode-ident-1.0.12/* %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/./subprojects/unicode-ident-1.0.12
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d build32
popd
pushd ..
cp -a mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732119438
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
cp %{_builddir}/mesa-83c2d82637d2b7d37a8d32d3ddcab28160fce04d/src/vulkan/screenshot-layer/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/c9e89168faf085da40190d78ade18b3a5d826c76 || :
