...
#
Name     : mesa
Version  : 22.2+1696.03ce740bbb
Release  : 337
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/a03ce740bbbd2364e37bdd358d634b352ff515c7/mesa-22.2+1696-ga03ce740bbb.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/a03ce740bbbd2364e37bdd358d634b352ff515c7/mesa-22.2+1696-ga03ce740bbb.tar.bz2
...
%prep
%setup -q -n mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7
cd %{_builddir}/mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7
%patch1 -p1
pushd ..
cp -a mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7 build32
popd
pushd ..
cp -a mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662308250
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-a03ce740bbbd2364e37bdd358d634b352ff515c7/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
