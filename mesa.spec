...
#
Name     : mesa
Version  : 24.0+453.g42fc83a6e3c
Release  : 668
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/mesa-24.0+453-g42fc83a6e3c.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/mesa-24.0+453-g42fc83a6e3c.tar.bz2
...
%prep
%setup -q -n mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83
cd %{_builddir}/mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83 build32
popd
pushd ..
cp -a mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705984651
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-42fc83a6e3cbf4521f7c2d2acf26bdf22dd73f83/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
