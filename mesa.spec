...
#
Name     : mesa
Version  : 24.2+4046.7b126f6273
Release  : 797
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/c7b126f6273eb4e60f3d36822593e90ad529251a/mesa-24.2+4046-gc7b126f6273.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/c7b126f6273eb4e60f3d36822593e90ad529251a/mesa-24.2+4046-gc7b126f6273.tar.bz2
...
%prep
%setup -q -n mesa-c7b126f6273eb4e60f3d36822593e90ad529251a
cd %{_builddir}
...
cd %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a
mkdir -p ./subprojects/paste-1.0.14
cp -r %{_builddir}/paste-1.0.14/* %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/./subprojects/paste-1.0.14
mkdir -p ./subprojects/syn-2.0.68
cp -r %{_builddir}/syn-2.0.68/* %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/./subprojects/syn-2.0.68
mkdir -p ./subprojects/proc-macro2-1.0.86
cp -r %{_builddir}/proc-macro2-1.0.86/* %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/./subprojects/proc-macro2-1.0.86
mkdir -p ./subprojects/quote-1.0.33
cp -r %{_builddir}/quote-1.0.33/* %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/./subprojects/quote-1.0.33
mkdir -p ./subprojects/unicode-ident-1.0.12
cp -r %{_builddir}/unicode-ident-1.0.12/* %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/./subprojects/unicode-ident-1.0.12
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a mesa-c7b126f6273eb4e60f3d36822593e90ad529251a build32
popd
pushd ..
cp -a mesa-c7b126f6273eb4e60f3d36822593e90ad529251a buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728868306
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
cp %{_builddir}/mesa-c7b126f6273eb4e60f3d36822593e90ad529251a/src/vulkan/screenshot-layer/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/c9e89168faf085da40190d78ade18b3a5d826c76 || :
