...
#
Name     : mesa
Version  : 19.0+2714.g604d89c2d10
Release  : 196
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/604d89c2d10f4d40bbdf06abded60b408547fe9f/mesa-19.0+2714-g604d89c2d10.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/604d89c2d10f4d40bbdf06abded60b408547fe9f/mesa-19.0+2714-g604d89c2d10.tar.bz2
...
%prep
%setup -q -n mesa-604d89c2d10f4d40bbdf06abded60b408547fe9f
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-604d89c2d10f4d40bbdf06abded60b408547fe9f build32
popd
pushd ..
cp -a mesa-604d89c2d10f4d40bbdf06abded60b408547fe9f buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1555046695
unset LD_AS_NEEDED
...
--with-gallium-drivers="radeonsi,r600,nouveau,svga,swrast" --enable-gallium-osmesa --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  %{?_smp_mflags}
popd
