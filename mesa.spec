...
#
Name     : mesa
Version  : 23.2.0+130.gf7c74e35eef
Release  : 511
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/f7c74e35eef06b6b6f5b14eff4a129fb9592e562/mesa-23.2.0+130-gf7c74e35eef.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/f7c74e35eef06b6b6f5b14eff4a129fb9592e562/mesa-23.2.0+130-gf7c74e35eef.tar.bz2
...
%prep
%setup -q -n mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562
cd %{_builddir}/mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562 build32
popd
pushd ..
cp -a mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689590477
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-f7c74e35eef06b6b6f5b14eff4a129fb9592e562/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
