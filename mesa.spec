...
#
Name     : mesa
Version  : 19.3+4743.g373f1eb9dea
Release  : 246
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/373f1eb9deab9d9435fba15be6de2a28bde79b87/mesa-19.3+4743-g373f1eb9dea.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/373f1eb9deab9d9435fba15be6de2a28bde79b87/mesa-19.3+4743-g373f1eb9dea.tar.bz2
...
%prep
%setup -q -n mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87
cd %{_builddir}/mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87 build32
popd
pushd ..
cp -a mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585953147
unset LD_AS_NEEDED
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dplatforms=x11,drm,wayland,surfaceless \
-Ddri3=true \
...
meson --libdir=lib32 --prefix=/usr --buildtype=plain -Dplatforms=x11,drm,wayland,surfaceless \
-Ddri3=true \
-Ddri-drivers=i915,i965,nouveau,r100,r200 \
-Dgallium-drivers=radeonsi,r600,nouveau,svga,swrast,iris \
-Dcpp_std=gnu++14 \
...
cp %{_builddir}/mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87/docs/license.html %{buildroot}/usr/share/package-licenses/mesa/8abacb09e25b69edf7b2ef6ac57b6be407769239
cp %{_builddir}/mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-373f1eb9deab9d9435fba15be6de2a28bde79b87/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
...
/usr/share/package-licenses/mesa/8abacb09e25b69edf7b2ef6ac57b6be407769239
