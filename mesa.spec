...
#
Name     : mesa
Version  : 19.0+7171.gf0d29238df3
Release  : 220
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/f0d29238df33d66ca4ee1e5f25a1edd9034f632e/mesa-19.0+7171-gf0d29238df3.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/f0d29238df33d66ca4ee1e5f25a1edd9034f632e/mesa-19.0+7171-gf0d29238df3.tar.bz2
...
%prep
%setup -q -n mesa-f0d29238df33d66ca4ee1e5f25a1edd9034f632e
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mesa-f0d29238df33d66ca4ee1e5f25a1edd9034f632e build32
popd
pushd ..
cp -a mesa-f0d29238df33d66ca4ee1e5f25a1edd9034f632e buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565663582
unset LD_AS_NEEDED
