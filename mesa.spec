...
#
Name     : mesa
Version  : 23.0+273.g7e68cf91d74
Release  : 415
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/7e68cf91d74e6bd9a88c2b52417451d9afec4782/mesa-23.0+273-g7e68cf91d74.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/7e68cf91d74e6bd9a88c2b52417451d9afec4782/mesa-23.0+273-g7e68cf91d74.tar.bz2
...
%prep
%setup -q -n mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782
cd %{_builddir}/mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782
%patch1 -p1
pushd ..
cp -a mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782 build32
popd
pushd ..
cp -a mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674083262
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-7e68cf91d74e6bd9a88c2b52417451d9afec4782/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
