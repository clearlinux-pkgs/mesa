...
Version  : 21.1.6
Release  : 271
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-21.1.6/mesa-mesa-21.1.6.tar.gz
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-21.1.6/mesa-mesa-21.1.6.tar.gz
...
%prep
%setup -q -n mesa-mesa-21.1.6
cd %{_builddir}/mesa-mesa-21.1.6
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a mesa-mesa-21.1.6 build32
popd
pushd ..
cp -a mesa-mesa-21.1.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627572454
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-mesa-21.1.6/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b0d2a6f767ca8a57b4029938c6710faa98de0110
cp %{_builddir}/mesa-mesa-21.1.6/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-mesa-21.1.6/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
