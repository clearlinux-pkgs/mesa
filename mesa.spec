...
#
Name     : mesa
Version  : 23.2.0+3880.g8d2dcd55d78
Release  : 551
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8d2dcd55d78cff504304e2c7aa8b76526c8be36b/mesa-23.2.0+3880-g8d2dcd55d78.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/8d2dcd55d78cff504304e2c7aa8b76526c8be36b/mesa-23.2.0+3880-g8d2dcd55d78.tar.bz2
...
%prep
%setup -q -n mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b
cd %{_builddir}/mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
pushd ..
cp -a mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b build32
popd
pushd ..
cp -a mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695217469
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-8d2dcd55d78cff504304e2c7aa8b76526c8be36b/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
