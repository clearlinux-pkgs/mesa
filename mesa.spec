...
%prep
%setup -q -n mesa-mesa-22.0.0
cd %{_builddir}/mesa-mesa-22.0.0
%patch1 -p1
%patch2 -p1
pushd ..
cp -a mesa-mesa-22.0.0 build32
popd
pushd ..
cp -a mesa-mesa-22.0.0 buildavx2
popd
...
cp %{_builddir}/mesa-mesa-22.0.0/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/ef04a499b857c3f38d05d737419bb4ec98bfa4fa
cp %{_builddir}/mesa-mesa-22.0.0/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683
cp %{_builddir}/mesa-mesa-22.0.0/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af
pushd ../build32/
