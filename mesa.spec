...
#
Name     : mesa
Version  : 24.0+800.g3304c6ca01e
Release  : 675
URL      : https://gitlab.freedesktop.org/mesa/mesa/-/archive/3304c6ca01ed89945c0c145b8474e59a7098eb8e/mesa-24.0+800-g3304c6ca01e.tar.bz2
Source0  : https://gitlab.freedesktop.org/mesa/mesa/-/archive/3304c6ca01ed89945c0c145b8474e59a7098eb8e/mesa-24.0+800-g3304c6ca01e.tar.bz2
...
%prep
%setup -q -n mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e
cd %{_builddir}/mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e build32
popd
pushd ..
cp -a mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706617640
unset LD_AS_NEEDED
...
cp %{_builddir}/mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e/docs/license.rst %{buildroot}/usr/share/package-licenses/mesa/b27952910869458b2b165aaf1d70b77d3bd1be06 || :
cp %{_builddir}/mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e/src/amd/vulkan/radix_sort/LICENSE %{buildroot}/usr/share/package-licenses/mesa/46aace8adc5b06990d9ee2b6bd555ea03c4df7a1 || :
cp %{_builddir}/mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e/src/imgui/LICENSE.txt %{buildroot}/usr/share/package-licenses/mesa/1871c6c7ddab444838aa6a57e6fa085d4e4de683 || :
cp %{_builddir}/mesa-3304c6ca01ed89945c0c145b8474e59a7098eb8e/src/mapi/glapi/gen/license.py %{buildroot}/usr/share/package-licenses/mesa/98d051673de64cfd533ded6d75f1526f5f4f27af || :
pushd ../build32/
